...
class AdmModuleLayoutController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('masterweb::module.admin.module_layout.list',compact('data'));
    }
    ...
    {
        //get auth user
        return view('masterweb::module.admin.module_layout.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('masterweb::module.admin.module_layout.edit',compact('module'));
    }
