...
use \Smt\Masterweb\Models\Gallery;
use SmtHelp;
use App\Http\Middleware\RoleCheck;
use Intervention\Image\Facades\Image;
use Smt\Masterweb\Models\Album;
...
class AdmGalleryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('masterweb::module.admin.gallery.list',compact('data'));
    }
    ...
    public function list($id)
    {
        ...
        return view('masterweb::module.admin.gallery.list',compact('data','album'));
    }
    ...
    public function create()
    {
        ...
        return view('masterweb::module.admin.gallery.add',compact('album'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('masterweb::module.admin.gallery.edit',compact('data','album'));
    }
