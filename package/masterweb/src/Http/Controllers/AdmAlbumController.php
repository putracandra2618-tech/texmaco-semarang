...
class AdmAlbumController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $data = Album::all();
        return view('masterweb::module.admin.gallery.list_category',compact('data'));
    }
    ...
    {
        //get auth user
        return view('masterweb::module.admin.gallery.add_category');
    }
    ...
    public function edit($id)
    {
        //get auth user
        $album = Album::find($id);
        return view('masterweb::module.admin.gallery.edit_category',compact('album'));
    }
