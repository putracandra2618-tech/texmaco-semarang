    ...
    <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="box-body table-responsive">
          <form action="{{ url('adm-maps/' . $option->id) }}" method="POST" enctype="multipart/form-data"
            class="forms-sample">
            @method('put')
            @csrf
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="text" name="latitude" readonly="readonly" id="lat"
                value="<?php echo $option['latitude']; ?>">
            </div>
            <div class="form-group">
              <label>LONGITUDE</label>
              <input class="form-control" type="text" name="longitude" readonly="readonly" id="lng"
                value="<?php echo $option['longitude']; ?>">
            </div>
            <div class="form-group">
              <label>ID PLACE</label>
              <input class="form-control" type="text" name="idplace" readonly="readonly" id="idplace"
                value="<?php echo $option['idplace']; ?>">
            </div>
