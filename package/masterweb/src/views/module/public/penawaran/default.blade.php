            ...
            <div class="container fes1-cont">
                <div class="row">
                    ...
                    <div class="col-md-5 fes1-img-cont wow fadeInUp mb-20">
                        <img src="{{asset('assets/public/images/penawaran/penawaran-smt.png')}}" alt="Penawaran Images" width="80%" style="height: auto !important;"> 
                    </div>
                    ...
                    <div class="col-md-7 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="container col-md-8 col-xs-12 col-sm-8">
                                ...
                                <div class="row">
                                    ...
                                    <form id="contact-form" action="{{url('create_offer')}}" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-10">
                                                <!-- <label>Your name *</label> -->
                                                <input type="text" value="" data-msg-required="" maxlength="100" class="controled" name="phone" id="phone" placeholder="Telephone" required>
                                            </div>
                                        </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 text-center-xxs tengah">
                                                    <input type="button" id="btn-save" value="Kirim penawaran" class="button medium blue mb-20" data-loading-text="Loading...">
                                                </div>
                                            </div>
