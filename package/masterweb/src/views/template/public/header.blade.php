...
function re_menu($id)
{
$subnav = \Smt\Masterweb\Models\Menu::where('publish','1')->where('upmenu',$id)->orderby('order')->get();
if (count($subnav)>0) {
@endphp
<ul class="sub">
                    ...
                    <div class="navbar navbar-default" role="navigation">
                        ...
                        <nav class="collapse collapsing navbar-collapse right-1024">
                            <ul class="nav navbar-nav">
                                ...
                                @php
                                //get data navigation
                                $nav = \Smt\Masterweb\Models\Menu::where('publish','1')->where('upmenu','0')->orderby('order')->get();

                                foreach ($nav as $nav_menu) {

                                $subnav = \Smt\Masterweb\Models\Menu::where('publish','1')->where('upmenu',$nav_menu->id)->orderby('order')->get();
                                if (count($subnav)>0) {
                                $sbb = "parent";
                                } else {
                                $sbb = "";
