...
class Smt {
    ...
    public static function getAction($action)
    {
            ...
            $role = \App\Models\AdminMenu::where('ms_menuadm.link', '=',  "/" . Request::segment(1))
    ...
    // return view('module.admin.laboratorium.coba',compact('role'));
...
<?php
    ...
    {
        return view('module.admin.layoutmodule.columns',compact('column','modules'));
    }

    public static function GetLayoutModulePublic($column,$modules)
    {
        return view('module.admin.layoutmodule.column_modules',compact('column','modules'));
    }
