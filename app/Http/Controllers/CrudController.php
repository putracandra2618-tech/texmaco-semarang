...
class CrudController extends Controller
{
    ...
    public function get_data($data)
    {
        ...
        return view('module.admin.crud',compact('set_columns','set_datas','set_fileds','set_displays','table','relation','set_upload'));
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->all() as $key => $value) {
            if (in_array($key,array($file_name,'_token',$columns[0],'deleted_at','created_at','updated_at'))){
                continue;
            }
    ...
    public function update(Request $request,$id)
    {
         ...
         $simpan = DB::table($table)->where($columns[0],$id)->update($data);
