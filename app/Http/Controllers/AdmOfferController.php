...
class AdmOfferController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $datas = Offer::all();
        return view('module.admin.offer.list',compact('datas'));
    }
    ...
    public function create()
    {
        ...
        return view('module.admin.offer.add', compact('menupublic'));
    }
    ...
    public function show($id)
    {
        ...
        return view('module.admin.offer.show',compact('data'));
    }
    ...
    public function edit($id)
    {
        $data = Offer::findOrFail($id);
        $menupublic = Menu::where(['publish'=>1])->Where('type','28')->get();
        return view('module.admin.offer.edit',compact('data', 'menupublic'));
    }
