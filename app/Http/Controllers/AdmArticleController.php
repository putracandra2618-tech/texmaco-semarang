...
class AdmArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('module.admin.article.list',compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('module.admin.article.add',compact('menupublic'));
    }
    ...
    public function show($id)
    {
        ...
        $menupublic = Menu::where(['publish'=>1])->Where('type','18')->get();
        return view('module.admin.article.detail',compact('menupublic','content'));
    }
    ...
    public function edit($id)
    {
        ...
        $content = Content::find($id);
        $menupublic = Menu::where(['publish'=>1])->Where('type','18')->get();
        return view('module.admin.article.edit',compact('menupublic','content'));
    }
