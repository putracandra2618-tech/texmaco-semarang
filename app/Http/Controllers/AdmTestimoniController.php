...
class AdmTestimoniController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $data = Testimoni::all();
        return view('module.admin.testimoni.list',compact('data'));
    }
    ...
    {
        //get auth user
        return view('module.admin.testimoni.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('file_testimoni')){
            ...
            $image = Image::make(public_path("/assets/public/images/testimoni/".$imgName))->resize(500,500)->save(public_path('/assets/public/images/testimoni_thumb/') . $imgName);
        }
        $data->save();
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.testimoni.edit',compact('testimoni'));
    }
