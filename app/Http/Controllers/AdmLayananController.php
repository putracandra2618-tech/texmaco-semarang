...
class AdmLayananController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $data = Layanan::all();
        return view('module.admin.layanan.list',compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('module.admin.layanan.add',compact('menupublic','data_cat'));
    }
    ...
    public function edit($id)
    {
        ...
        $menupublic = Menu::where(['publish'=>1])->Where('type','28')->get();
        $data_cat = CategoryLayanan::all();
        return view('module.admin.layanan.edit',compact('menupublic','layanan','data_cat'));
    }
