...
class AdmCategoryPortofolioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('module.admin.portofolio.list_category',compact('data'));
    }
    ...
    {
        //get auth user
        return view('module.admin.portofolio.add_category');
    }
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.portofolio.edit_category',compact('categoryportofolio'));
    }
