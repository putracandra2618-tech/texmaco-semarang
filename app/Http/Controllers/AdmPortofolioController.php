...
class AdmPortofolioController extends Controller
{
    ...
    {
        //get auth user
        $data = Portofolio::all()->sortByDesc('created_at');
        return view('module.admin.portofolio.list_portofolio',compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('module.admin.portofolio.add_portofolio',compact('data_cat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('file_portofolio')){
            ...
            $image = Image::make(public_path("/assets/public/images/portofolio/".$imgName))->resize(410,216)->save(public_path('/assets/public/images/portofolio_thumb/') . $imgName);
        }
        $data->save();
    ...
    public function edit($id)
    {
        ...
        $data_cat = CategoryPortofolio::all();
        return view('module.admin.portofolio.edit_portofolio',compact('get_data','data_cat'));
    }
