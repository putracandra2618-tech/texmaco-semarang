...
class AdmSosmedController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $datas = Socmed::all();
        return view('module.admin.sosmed.list',compact('datas'));
    }
    ...
    {
        //get auth user
        return view('module.admin.sosmed.add');
    }
    ...
    public function show($id)
    {
        ...
        return view('module.admin.sosmed.detail', compact('data'));
    }
    ...
    public function edit($id)
    {
        //get auth user
        $data = Socmed::find($id);
        return view('module.admin.sosmed.edit',compact('data'));
    }
