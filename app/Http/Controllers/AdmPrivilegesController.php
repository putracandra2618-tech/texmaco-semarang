...
class AdmPrivilegesController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $data = Privileges::all();
        return view('module.admin.privilege.list',compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('module.admin.privilege.add',compact('menuadm'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.privilege.edit',compact('menuadm','privilege'));
    }
