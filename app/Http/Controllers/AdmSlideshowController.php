...
class AdmSlideshowController extends Controller
{
    ...
    public function index()
    {
        //get auth user
        $data = Slideshow::all();
        return view('module.admin.slideshow.list',compact('data'));
    }
    ...
    {
        //get auth user
        return view('module.admin.slideshow.add');
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('images')){
            ...
            $data->images = $imgName;
            $image = Image::make(public_path("/assets/public/images/slideshow/".$imgName))->resize(500,500)->save(public_path('/assets/public/images/slideshow_thumb/') . $imgName);
            // dd($image);
        }
        $data->save();
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.slideshow.edit',compact('slideshow'));
    }
