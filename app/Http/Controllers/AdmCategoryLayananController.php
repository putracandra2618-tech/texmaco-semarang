...
class AdmCategoryLayananController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('module.admin.layanan.list_category',compact('data'));
    }
    ...
    {
        //get auth user
        return view('module.admin.layanan.add_category');
    }
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.layanan.edit_category',compact('data'));
    }
