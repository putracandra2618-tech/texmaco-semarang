...
class AdmContentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('module.admin.content.list',compact('data'));
    }
    ...
    public function create()
    {
        ...
        //get all menu public
        $menupublic = Menu::where(['publish'=>1])->Where('type','15')->orWhere('type','28')->get();
        
        return view('module.admin.content.add',compact('menupublic'));
    }
    ...
    public function show($id)
    {
        ...
        $menupublic = Menu::where(['publish'=>1])->Where('type','15')->orWhere('type','28')->get();
        return view('module.admin.content.detail',compact('menupublic','content'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('module.admin.content.edit',compact('menupublic','content'));
    }
