  ...
  <div class="card">
    <div class="card-body">
      ...
      @foreach ($contacts as $contact)
        <form enctype="multipart/form-data" class="forms-sample" action="{{ url('contact/' . $contact->id) }}"
          method="POST">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" name="email" placeholder="sevenmediatech@gmail.com"
              value="{{ $contact->email }}">
          </div>

          <div class="form-group">
            <label for="phone"></label>
            <input type="text" class="form-control" id="phone" name="phone" placeholder="081xxx"
              value="{{ $contact->phone }}">
          </div>
