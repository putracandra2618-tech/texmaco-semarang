        ...
        <div class="template-demo">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom bg-inverse-primary">
              ...
              <li class="breadcrumb-item"><a href="#">Data {{ request()->segment(2) }}</a></li>
    ...
    <form action="/master/SMUpdate/{{request()->segment(4)}}" id="form-tambah" class="forms-sample" method="post">
        ...
        {{-- make session get table --}}
            @php
                ...
                $set = DB::table($table)->where($columns[0],$id)->first();
                // dd($set);
            @endphp
        {{-- make session get table --}}
                ...
                @foreach ($datas as $data)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{'/master/'.request()->segment(2).'/edit/'.$data->$set_key}}">
                                <button type="button" class="btn btn-outline-warning btn-rounded btn-icon">
                                    <i class="fas fa-pencil-alt"></i>                                                    
                                </button> 
                            </a>
                            <button type="button" class="btn btn-outline-danger btn-rounded btn-icon btn-hapus" data-id="{{ $data->$set_key }}" data-table="{{ $table }}">
