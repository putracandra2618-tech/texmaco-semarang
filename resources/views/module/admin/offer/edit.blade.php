...
@section('content')
  <div class="card">
    <div class="card-body">
      ...
      <form enctype="multipart/form-data" class="forms-sample" action="{{ route('admoffer.update', [$data->id]) }}"
        method="POST">
        @csrf
        @method('patch')
        ...
        <div class="form-group">
          ...
          <input type="file" class="dropify" name="foto"
            data-default-file="{{ asset('assets/public/images/layanan/' . $data->foto) }}" />
        </div>
