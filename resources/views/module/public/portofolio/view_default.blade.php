...
$get_data = \App\Models\Portofolio::where('name_portofolio',$link)->first();

//loop
$data_cat = \App\Models\CategoryPortofolio::orderBy('name_category_portofolio', 'asc')->get();
$data = \App\Models\Portofolio::where([['publish','=','1'],['name_portofolio','<>',$link]])->orderBy('created_at','DESC')->paginate(6);
                ...
                <center>
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-30">
                            {{ $data->links("template.public.pagination") }}
                        </div>
                </center>
            </div>
        </div>
