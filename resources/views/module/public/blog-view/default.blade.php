@php
    ...
    $artikel = \App\Models\Content::orderBy('date','DESC')->where([['publish', '1'],['type', '0']])->paginate(6);
    //update views
    $content = \App\Models\Content::findOrFail($get_artikel->id_content);
        ...
        <div class="blog-post wow fadeIn pb-50">
            ...
            <div class="wow fadeIn pb-80">
                ...
                <div class="post-prev-title">
                    <span class="gotham-medium-red"><span class="bold label label-primary">Blog</span> {{  SmtHelp::fdate(explode(' ',$get_artikel->date)[0],"DDMMYYYY") }} / {{ $get_artikel->author }}</span>
